...
export const MealAPI = {
    searchMealsByName: async (query) => {
        try {
            ...
            console.error("Error searching the meal:", error);
            return [];
        }
    },
    getMealByID: async (id) => {
        try {
            ...
            console.error("Error getting the meal by id:", error);
            return null;
        }
    },
    getRandomMeal: async (id) => {
        try {
    ...
    filterByIngredient: async (ingredient) => {
        try {
            ...
            console.error("Error while filtering by ingredient:", error);
            return [];
        }
    },
    ...
    filterByCategory: async (category) => {
        try {
            ...
            console.error("Error while filtering by category:", error);
            return [];
        }
    },
